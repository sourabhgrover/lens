...
export const ATTACHMENT_TYPE_QUICKREPLY_ACTION = "quickReplyAction";
export const ATTACHMENT_TYPE_QUICKREPLY_ATTACHMENT = "attachment";
export const ATTACHMENT_TYPE_QUICKREPLY_URL = "url";
export const ATTACHMENT_TYPE_QUICKREPLY_OPENAPP = "openApp";
